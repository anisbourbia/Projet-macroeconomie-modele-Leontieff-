...
C[1] <- 40 #on doit choisir une comp. de C car sans le système est indéterminé
d <- matrix(c(45,25,4.85,55,40,9,60,50,10,88,145,24.15),n,q)
m <- c(74.85,104,120,257.15)
